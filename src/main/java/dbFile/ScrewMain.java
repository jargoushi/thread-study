...
public class ScrewMain {
    ...
    private static final String DB_URL = "jdbc:sqlserver://web-homedo.sqlserver201417216220168.fat.homedo.com";
    private static final String DB_NAME = "HomeDo_Dev";
    private static final String DB_USERNAME = "HomeDo";
    private static final String DB_PASSWORD = "hmd!@#";

    private static final String FILE_OUTPUT_DIR = "D:\\学习资料";
